...
- 上: (100, 30) ✓   下: (100, 170) ✓
- 左: (30, 100) ✓   右: (170, 100) ✓
- 左上: (60, 60) → |40|+|40|=80 < 99 ✓
- 右上: (140, 60) → |40|+|40|=80 < 99 ✓
- 左下: (60, 140) → |40|+|40|=80 < 99 ✓
- 右下: (140, 140) → |40|+|40|=80 < 99 ✓
★ 错误坐标: (20, 20) → |80|+|80|=160 > 99 ✗ (在菱形外面！)
...
第四步 - 设置出生点（★★ 极其重要！必须为每个玩家放一个 ★★）：
  ...
  示例：4人图四角出生点，地图100x100 (W=100) 时：
    set_waypoint: waypointIndex=0, x=60, y=60    (左上, |40|+|40|=80<99 ✓)
    set_waypoint: waypointIndex=1, x=140, y=60   (右上, |40|+|40|=80<99 ✓)
    set_waypoint: waypointIndex=2, x=60, y=140   (左下, |40|+|40|=80<99 ✓)
    set_waypoint: waypointIndex=3, x=140, y=140  (右下, |40|+|40|=80<99 ✓)
