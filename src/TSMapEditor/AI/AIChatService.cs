...
- 矿石偏移量只需要 5-8%，不要太远！
- 具体示例（2v2地图）：
  * 玩家1在(15,15) -> 矿石放(20,15)和(15,20)
  * 玩家2在(85,85) -> 矿石放(80,85)和(85,80)
  * 玩家3在(85,15) -> 矿石放(80,15)和(85,20)
  * 玩家4在(15,85) -> 矿石放(20,85)和(15,80)
- 绝对禁止在出生点的相同位置放矿石！
- 矿石半径用 5-7，不要太大
...
- 你可以使用 get_map_info 返回的可用地面类型中的任何名称作为 terrain 参数
